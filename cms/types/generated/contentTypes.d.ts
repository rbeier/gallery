...
export interface ApiAlbumAlbum extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A portfolio grouping of photographs';
    displayName: 'Album';
    pluralName: 'albums';
    singularName: 'album';
  };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    photographer: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Robin Beier'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A reusable place name';
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'A reusable photo tag';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
